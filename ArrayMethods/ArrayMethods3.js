...
//* 17) flat() -> flats a single array
const arr = [1, [2, [3, [5]]], 4];
console.log(arr);
console.log(arr.flat());
console.log(arr.flat(Infinity)); //length of infinity array to single

//* 18) indexOf() -> 1st index of the element in an array and lastIndexOf() ->last index of the element in an array

const ele = [1, 2, 3, 4, 5, 6, 3, 6, 3, 4, 90];
console.log(ele.indexOf(3));
console.log(ele.lastIndexOf(3));
console.log(ele.lastIndexOf(87)); //! returns -1 because the element is not present in an array
console.log(ele.indexOf(87))//! returns -1 because the element is not present in an array
...
//* 21) sum() -> returns true or false depending on whether some elements satisfies the condition
